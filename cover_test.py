...
# a = np.array(a)
# b = np.array(b)
# np.savetxt('controller.txt',a)
# np.savetxt('fixcontroller.txt',b)
# n = a.__len__()
# n += b.__len__()
# print(n)
...
# node_id_position = node_position[:, [1, 2]]
# node_id_position = np.array(node_id_position)
# np.savetxt('vehicle.txt',node_id_position)
# # addition.multiobj(len(a), node_id_position, a, b)
#
# a = np.array(a)
# fig = plt.figure(figsize=(8, 7.82), dpi=80)
